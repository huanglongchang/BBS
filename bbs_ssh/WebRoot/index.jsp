...
if(al==null){
System.out.printf("NULLL");
}
for(Message n:al){
%>
		    <li>
		      <h2> <span > &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <%= n.getId()%>  </span>  &nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp  &nbsp&nbsp&nbsp&nbsp  <span><a href="showMessage.jsp?MessageId=<%= n.getId()%> "> <%= n.getTitle()%> </a>  &nbsp&nbsp&nbsp&nbsp </span> </a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <span > <%= n.getNewDate()%></span> </h2>
		        <p></p>
		    </li>
	<%	
	}	
